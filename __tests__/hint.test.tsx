...
const MockHintUI = ({ handleHintSelection, hintLabelText, isToggleDisabled, areHintButtonsDisabled }: any) => (
  <View>
    <Text>{hintLabelText}</Text>
    <Pressable
        onPress={() => {
          if (!isToggleDisabled && !areHintButtonsDisabled && handleHintSelection) {
...
const mockUseHintLogic = useHintLogic as jest.MockedFunction<typeof useHintLogic>;
