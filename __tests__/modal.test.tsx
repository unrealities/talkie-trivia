...
const mockMovie: Movie = {
  ...
  credits: {
    cast: [{ id: 1, name: 'Actor One', character: 'Character One', profile_path: '/actor1.jpg', order: 1, job: 'Acting' }],
    crew: [{ id: 2, name: 'Director One', job: 'Director', profile_path: '/director1.jpg', department: 'Directing' }],
  },
  runtime: 120,
};
