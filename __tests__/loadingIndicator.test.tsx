...
jest.mock('../src/components/customLoadingIndicator', () => {
  return ({ message }: { message?: string }) => {
    return <mock-customloadingindicator testID="custom-loading-indicator" message={message} />;
  };
});
...
describe('LoadingIndicator', () => {
  ...
  it('renders the CustomLoadingIndicator component', () => {
    render(<LoadingIndicator />);
    const customLoadingIndicator = screen.getByTestId('custom-loading-indicator');
